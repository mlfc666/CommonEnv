...
// 左侧头像预览组件负责展示用户形象并触发文件系统选择逻辑
const AvatarCard: React.FC<{ avatar: string; username: string; id: number; onUpload: (file: File) => void }> = ({
                                                                                                                    avatar,
                                                                                                                    username,
                                                                                                                    id,
                                                                                                                    onUpload
            ...
            <div className="card-body items-center text-center p-10">
                ...
                <div className="w-full mt-10">
                    ...
                    <label htmlFor="avatar-upload"
                           className="btn btn-outline border-base-300 btn-block h-12 font-bold hover:bg-base-200 cursor-pointer text-base-content">
            ...
            <div className="card-body gap-8 p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <fieldset className="fieldset">
                        ...
                        <label
                            className="input input-bordered flex items-center gap-3 h-12 rounded-lg bg-base-200 cursor-not-allowed">
                    ...
                    <fieldset className="fieldset col-span-full">
                        ...
                        <label
                            ...
                            <input type="text" value={new Date(user.createTime).toLocaleDateString()}
                                   className="grow text-base" readOnly/>
                        </label>
                    </fieldset>
                </div>
                <div className="card-actions justify-end mt-4">
                    <button onClick={() => onUpdate(editName)}
                            className="btn bg-base-content text-base-100 px-10 h-12 rounded-lg text-base font-bold shadow-lg shadow-base-content/10 hover:bg-black transition-all border-none">
